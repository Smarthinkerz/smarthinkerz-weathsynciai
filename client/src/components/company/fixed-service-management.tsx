...
export const ServiceManagement = () => {
  ...
  // Force data display regardless of loading state
  ...
  return (
    <Card className="w-full mb-6">
      ...
      <CardContent>
        {/* Debug code removed - no longer visible to users */}
        ...
        {error ? (
          ...
          // Display services - force correct typing with explicit array map
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="mt-4 border rounded-md p-4 bg-muted/50">
            ...
            <p className="text-sm mt-1 text-muted-foreground">{selectedService?.description}</p>
          </div>

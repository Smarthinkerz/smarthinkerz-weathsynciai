...
export const countries: Country[] = [
  ...
  { name: "Congo, Democratic Republic of the", code: "congo-democratic-republic" },
  { name: "Congo, Republic of the", code: "congo-republic" },
  { name: "Costa Rica", code: "costa-rica" },
  { name: "Côte d'Ivoire", code: "cote-divoire" },
  ...
  { name: "Korea, North", code: "north-korea" },
  { name: "Korea, South", code: "south-korea" },
